...
const Products = ({productItems, handleAddButton}) => {
    return ( 
        <section className="w-full min-h-[100vh] flex flex-col items-center pt-5 bg-white">
            ...
            {productItems.map((item, index) => {return(
                ...
                <span key={index} className="w-[250px] py-[12px] px-[25px] border border-[#888] flex flex-col justify-center rounded-lg text-start cursor-pointer gap-[6px] relative duration-500 hover:shadow-md hover:shadow-[#888]">
