        ...
        <section className="w-full h-screen flex items-center justify-center relative">
            ...
            <div className="w-[85%]  lg:w-2/3 py-4 mt-[40px] lg:mt-0 flex flex-col items-center">
                ...
                <form className="SignIn text-[#333] w-full 2sm:w-3/4 sm:w-2/3 text-start px-2 mt-3">
                    ...
                    <input className="w-full h-[35px] border border-[#888] rounded-sm mb-2 text-[22px] px-2 py-1  outline-[#00c0ff]" type="text" id="displayName"  onChange={(e)=>setRegUser(e.target.value)}/><br/>
                    <label htmlFor="email">Email</label><br/>
                    <input className="w-full h-[35px] border border-[#888] rounded-sm mb-2 text-[22px] px-2 py-1  outline-[#00c0ff]" type="email" id="email" onChange={(e)=>setRegUser(e.target.value)}/><br/>
                    <label htmlFor="password">Password</label><br/>
                    <input className="w-full h-[35px] border border-[#888] rounded-sm mb-2 text-[22px] px-2 py-1  outline-[#00c0ff]" type="password" id="password" onChange={(e)=>setRegUser(e.target.value)}/><br/>
